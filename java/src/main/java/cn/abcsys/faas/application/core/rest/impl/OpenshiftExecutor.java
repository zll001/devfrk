 ...
 */
package cn.abcsys.faas.application.core.rest.impl;
...
import cn.abcsys.faas.application.core.rest.ContainerRestfulExecutor;
 ...
 * 2018年3月11日
 */
public class OpenshiftExecutor extends ContainerRestfulExecutor {


	public final static Set<String> workloadControllers = new HashSet<String>();
	...
	protected Object doCreate(Object client, String kind, Map<String, Map<String, Object>> params) throws Exception {
		...
		OpenshiftModelGenerator generator = new OpenshiftModelGenerator(getObjectRef());
	...
	protected String getDesc(String kind) {
		try {
			return StringUtils.isNull(kind) ? "" : new OpenshiftKindAnalyzer().getKindDesc(kind);
		} catch (Exception e) {
			return null;
		}
	}
